    ...
    <Container maxWidth={false}>
      ...
      transition={{ duration: 0.5, delay: 0.2, ease: 'easeInOut' }}
        ...
        className="relative learning-ifa ">
          <div className="border-[10px] absolute  border-[#74B117] lg:h-[89vh] h-[44vh] lg:w-[80vh] w-[40vh] "></div>

          <div className="border-2 bg-white absolute lg:left-[-30px] left-[-10px] top-2 border-[#74B117] lg:w-[80vh] w-[38vh] lg:p-8 p-3 lg:h-[80vh] h-[42vh] mt-5 ">
            ...
            <p className="lg:text-[20px] text-[10px] leading-tight mt-4 text-[#6C6C72]">
              ...
              Built for the spiritually curious, the committed learner, and the
