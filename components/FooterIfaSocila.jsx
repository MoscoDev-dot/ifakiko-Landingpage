...
const FooterIfaSocila = () => {
  return (
    <div>
      <NavImage />
      <div className="mt-4">
        <p className="md:text-[16px] text-[13px] text-white leading-[24px] ">
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. <br /> Quos
          perspiciatis quo eos fugit, ex earum minus velit deserunt <br /> amet
          sit dolorum voluptatibus, asperiores cupiditate soluta.
        </p>
      </div>
